...
module.exports = function(app) {
  ...
  app.post('/assets/save', User.signinRequired, Assets.save);
  ...
  app.post('/bond/save', User.signinRequired, Bond.save);
  ...
  app.post('/borrowing/save', User.signinRequired, Borrowing.save);
  ...
  app.post('/payment/save', User.signinRequired, Payment.save);
  ...
  app.post('/share/save', User.signinRequired, Share.save);
  ...
  app.post('/wishlist/save', User.signinRequired, Wishlist.save);
  app.get('/wishlist/buy', User.signinRequired, Wishlist.buy);
